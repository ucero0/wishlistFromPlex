...
# Add the fastapi-app root to the path
# Go up from: services/fastapi-app/migrations/alembic/env.py
# To reach fastapi-app root (3 levels up: alembic -> migrations -> fastapi-app root)
...
def run_migrations_online() -> None:
    ...
    # Alembic uses sync engine, so convert async URL to sync URL
    # Convert postgresql+asyncpg:// to postgresql:// for sync operations
