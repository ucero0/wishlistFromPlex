...
def _scan(**kwargs) -> AntivirusScan:
    defaults = {
        "guidProwlarr": "guid-1",
        "Infected": False,
        "scanDateTime": datetime(2026, 1, 1),
    }
