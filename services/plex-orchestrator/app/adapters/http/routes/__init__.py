...
from app.adapters.http.routes.deluge.deluge_torrent_health_routes import (
    deluge_torrent_health_routes,
)
...
delugeRoutes.include_router(deluge_torrent_health_routes)
